...
// build a remote API data access
export const getAllPaymentsFetchVersion = async () => {
    const url = "https://payments.neueda.com/api/payment"
    const transactionsPromise = await fetch(url, {
        method: 'GET',
        headers: new Headers(
...
// write a component to use that remote data
